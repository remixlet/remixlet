...
import { ChevronDown, Mail, MessagesSquare, Plus, Settings } from "lucide-react";
...
// Same mark as the marketing site's GitHub link. Lucide deliberately carries
// interface symbols rather than third-party brand logos.
  ...
  return (
    <div className="flex min-h-dvh">
      <aside className="sticky top-0 flex h-dvh w-64 shrink-0 flex-col border-r border-[var(--line-soft)] bg-card lg:w-[19.2rem]" aria-label="Remixlet navigation">
        ...
        <div id="sidebar-summary" className="border-t px-4 py-3 text-xs text-muted-foreground">
        ...
        <AlertDialog open={feedbackOpen} onOpenChange={setFeedbackOpen}>
          <AlertDialogContent id="feedback-dialog" className="sm:max-w-md">
            <AlertDialogHeader>
              <AlertDialogTitle>Feedback</AlertDialogTitle>
              <AlertDialogDescription>All feedback is appreciated.</AlertDialogDescription>
            </AlertDialogHeader>
            <div className="grid gap-2 sm:grid-cols-2">
              <a
                href="mailto:darian@remixlet.com"
                data-feedback-channel="email"
                className="group flex items-center gap-3 rounded-lg border bg-card p-3 text-left text-foreground transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                ...
                <span className="min-w-0">
                  ...
                  <span className="block truncate text-xs text-muted-foreground">darian@remixlet.com</span>
                </span>
              </a>
              <a
                href="https://github.com/remixlet/remixlet/issues/new"
                target="_blank"
                rel="noreferrer"
                data-feedback-channel="github"
                className="group flex items-center gap-3 rounded-lg border bg-card p-3 text-left text-foreground transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                <span className="flex size-9 shrink-0 items-center justify-center rounded-md bg-secondary text-muted-foreground transition-colors group-hover:text-foreground">
                ...
                <span className="min-w-0">
                  <span className="block text-sm font-medium">GitHub Issues</span>
                  <span className="block truncate text-xs text-muted-foreground">Click New Issue</span>
                </span>
              </a>
            </div>
            <AlertDialogFooter>
